...
def road_detect():
    ...
    while True:
        ...
        transformed_frame = perspective_transform(img, matrix, window_width, window_height)
        transformed_frame_hsv = perspective_transform(hsv_img, matrix, window_width, window_height)
